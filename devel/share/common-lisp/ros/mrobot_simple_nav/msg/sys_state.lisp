...
(cl:defmethod cl:initialize-instance :after ((m <sys_state>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'sys_state)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mrobot_simple_nav-msg:<sys_state> is deprecated: use mrobot_simple_nav-msg:sys_state instead.")))
