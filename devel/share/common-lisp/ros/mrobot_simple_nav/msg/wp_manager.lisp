...
(cl:defmethod cl:initialize-instance :after ((m <wp_manager>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'wp_manager)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mrobot_simple_nav-msg:<wp_manager> is deprecated: use mrobot_simple_nav-msg:wp_manager instead.")))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <wp_manager>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrobot_simple_nav-msg:state-val is deprecated.  Use mrobot_simple_nav-msg:state instead.")
  (state m))
