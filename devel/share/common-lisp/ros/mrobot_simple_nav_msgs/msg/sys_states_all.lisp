...
(cl:defmethod cl:initialize-instance :after ((m <sys_states_all>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'sys_states_all)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mrobot_simple_nav_msgs-msg:<sys_states_all> is deprecated: use mrobot_simple_nav_msgs-msg:sys_states_all instead.")))

(cl:ensure-generic-function 'state0-val :lambda-list '(m))
(cl:defmethod state0-val ((m <sys_states_all>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrobot_simple_nav_msgs-msg:state0-val is deprecated.  Use mrobot_simple_nav_msgs-msg:state0 instead.")
  (state0 m))

(cl:ensure-generic-function 'state1-val :lambda-list '(m))
(cl:defmethod state1-val ((m <sys_states_all>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrobot_simple_nav_msgs-msg:state1-val is deprecated.  Use mrobot_simple_nav_msgs-msg:state1 instead.")
  (state1 m))

(cl:ensure-generic-function 'state2-val :lambda-list '(m))
(cl:defmethod state2-val ((m <sys_states_all>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrobot_simple_nav_msgs-msg:state2-val is deprecated.  Use mrobot_simple_nav_msgs-msg:state2 instead.")
  (state2 m))

(cl:ensure-generic-function 'state3-val :lambda-list '(m))
(cl:defmethod state3-val ((m <sys_states_all>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrobot_simple_nav_msgs-msg:state3-val is deprecated.  Use mrobot_simple_nav_msgs-msg:state3 instead.")
  (state3 m))

(cl:ensure-generic-function 'state4-val :lambda-list '(m))
(cl:defmethod state4-val ((m <sys_states_all>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrobot_simple_nav_msgs-msg:state4-val is deprecated.  Use mrobot_simple_nav_msgs-msg:state4 instead.")
  (state4 m))

(cl:ensure-generic-function 'state5-val :lambda-list '(m))
(cl:defmethod state5-val ((m <sys_states_all>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrobot_simple_nav_msgs-msg:state5-val is deprecated.  Use mrobot_simple_nav_msgs-msg:state5 instead.")
  (state5 m))

(cl:ensure-generic-function 'state6-val :lambda-list '(m))
(cl:defmethod state6-val ((m <sys_states_all>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrobot_simple_nav_msgs-msg:state6-val is deprecated.  Use mrobot_simple_nav_msgs-msg:state6 instead.")
  (state6 m))

(cl:ensure-generic-function 'state7-val :lambda-list '(m))
(cl:defmethod state7-val ((m <sys_states_all>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrobot_simple_nav_msgs-msg:state7-val is deprecated.  Use mrobot_simple_nav_msgs-msg:state7 instead.")
  (state7 m))

(cl:ensure-generic-function 'state8-val :lambda-list '(m))
(cl:defmethod state8-val ((m <sys_states_all>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrobot_simple_nav_msgs-msg:state8-val is deprecated.  Use mrobot_simple_nav_msgs-msg:state8 instead.")
  (state8 m))

(cl:ensure-generic-function 'state9-val :lambda-list '(m))
(cl:defmethod state9-val ((m <sys_states_all>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrobot_simple_nav_msgs-msg:state9-val is deprecated.  Use mrobot_simple_nav_msgs-msg:state9 instead.")
  (state9 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<sys_states_all>)))
  ...
  "mrobot_simple_nav_msgs/sys_states_all")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'sys_states_all)))
  "Returns string type for a message object of type 'sys_states_all"
  "mrobot_simple_nav_msgs/sys_states_all")
