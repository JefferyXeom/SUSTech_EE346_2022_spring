...
// (in-package mrobot_simple_nav.msg)
...
class sys_state {
  ...
  static datatype() {
    ...
    return 'mrobot_simple_nav/sys_state';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new sys_state(null);
